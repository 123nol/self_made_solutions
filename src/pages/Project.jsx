      ...
      <div className='prolists'>
        ...
        <div className='prolist' >
          ...
          <div className='listinfo'>
            ...
            <p style={{fontWeight: "50px", color:"white"}}>Along with the logo design, we were tasked to design and develop an easy-to-use website application that delivers on three basic requirements:
...
Checkout the website here ..</p>
        ...
        <div className='prolist' >
          ...
          <div className='listinfo'>
            ...
            <p style={{fontWeight: "50px", color:"white"}}>currently in development
...
Checkout the website here ...</p>
        ...
        <div className='prolist' >
          ...
          <div className='listinfo'>
            ...
            <p style={{fontWeight: "50px", color:"white"}}>For an annual Job Fair event held in Addis Ababa University, we prepared and pushed branding materials for a call center and digital rescue aid service, Hello Yet. Specifically for the purpose of the event, we designed and prepared different banners, t-shirts, business cards and flyers and other printable assets.</p>
...
Checkout the look here ...</p>
        ...
        <div className='prolist' >
          ...
          <div className='listinfo'>
            ...
            <p style={{fontWeight: "50px", color:"white"}}>We were contracted to design a website that showcases basic services provided by the newly formed company, and design it in a colorful manner that would highlight the traditions and landmarks of Addis Ababa city.</p>
