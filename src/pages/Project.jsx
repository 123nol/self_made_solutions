      ...
      <div className='prolists'>
        ...
        <div className='prolist' >
          ...
          <div className='listinfo'>
            ...
            <p>Along with the logo design, we were tasked to design and develop an easy-to-use website application that delivers on three basic requirements:
...
Checkout the website here ...</p>
        ...
        <div className='prolist' >
          ...
          <div className='listinfo'>
            ...
            <p>For an annual Job Fair event held in Addis Ababa University, we prepared and pushed branding materials for a call center and digital rescue aid service, Hello Yet. Specifically for the purpose of the event, we designed and prepared different banners, t-shirts, business cards and flyers and other printable assets.</p>
...
Checkout the look here ...</p>
        ...
        <div className='prolist' >
          ...
          <div className='listinfo'>
            ...
            <p>We were contracted to design a website that showcases basic services provided by the newly formed company, and design it in a colorful manner that would highlight the traditions and landmarks of Addis Ababa city.</p>
        ...
        <div className='prolist' >
          ...
          <div className='listinfo'>
            ...
            <p>We held to capture the time and place memories for the 2021 annual event held for employees by Lesso Ethiopia. Organised to appreciate its staff and partners, and with that put its prints on the Green Legacy campaign, Est Infinity Marketing organized an event for Lesso Ethiopia.</p>
